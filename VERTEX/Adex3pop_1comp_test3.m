...
%Connections
ConnectionParams(1).numConnectionsToAllFromOne ={0,7,7}; 
...
ConnectionParams(2).numConnectionsToAllFromOne ={4,0,4};
...
ConnectionParams(2).weights ={5,4,10};
...
ConnectionParams(3).numConnectionsToAllFromOne ={3,3,0};
...
RecordingSettings.saveDir=['Adex3pop_1comp_test3', filesep];
RecordingSettings.LFP=false;
RecordingSettings.v_m =6:6:18;
...
% conversion to LEMS
cells_to_display={5,4,3};
model_path=which('VERTEX_Adex_LEMS.xml');
VERTEX_Adex_1comp_to_LEMS(params,connections,0.01,model_path,['..' filesep '..' filesep 'test_LEMS' filesep],'Adex3pop_1comp_test3',cells_to_display);
...
set(gcf,'color','w');
set(gca,'FontSize',16)
title('Membrane potential traces of three Adex point neurons ID=6, ID=12, ID=18', 'FontSize', 16)
