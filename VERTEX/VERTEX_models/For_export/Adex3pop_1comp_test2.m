...
ConnectionParams(2).numConnectionsToAllFromOne ={0,0,1};
...
RecordingSettings.saveDir=['Adex3pop_1comp_test2', filesep];
...
VERTEX_Adex_1comp_to_LEMS(params,connections,0.01,model_path,['..' filesep '..' filesep 'test_LEMS' filesep],'Adex3pop_1comp_test2',cells_to_display);
