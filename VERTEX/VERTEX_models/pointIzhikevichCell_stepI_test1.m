...
RecordingSettings.saveDir=['pointIzhikevichCell_stepI_test1', filesep];
RecordingSettings.LFP=false;
RecordingSettings.v_m = 1;
RecordingSettings.maxRecTime = 100;
RecordingSettings.sampleRate = 32000; % increase sampling rate for high-rate spiking neurons
...
% conversion to LEMS
cells_to_display={0};
VERTEX_IzhikevichCell_to_LEMS(params,connections,0.01,['..' filesep '..' filesep 'test_LEMS' filesep],'pointIzhikevichCell_stepI_test1',cells_to_display);
